import { Button, Card, Link, Stack, Typography, Grid } from "@mui/material";
...
const PostBrowser = (props) => {
  ...
  return (
    <Stack spacing={2}>
      <Card sx={{ position: 'sticky', top: 0, zIndex: 2, mb: 2, p: 1 }} elevation={3}>
      ...
      {searchExists && (
        <Box>
          <Typography variant="h5" gutterBottom>
            Showing results for "{search.get("search")}"</Typography>
